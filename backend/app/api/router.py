...
from backend.app.api.endpoints import auth, chat, health  # 🔥 SEKARANG HEALTH SUDAH PUNYA SEKTOR SENDIRI
...
print("🔀 [ROUTER] Hub utama api_router sukses memuat sub-router /auth, /chat, dan /health, bolo!")