...
with open("backend/app/services/pipeline/prompts/rag_prompts.py", "r") as f:
    content = f.read()

# We will just rewrite the file safely in python
...
with open("backend/app/services/pipeline/prompts/rag_prompts.py", "w") as f:
    f.write(new_content)
