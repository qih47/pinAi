...
import DocumentListPanel from "@/features/chat/components/DocumentListPanel";
        ...
        <> {/* ==========================================================
          ...
          ========================================================== */}
            ...
            <div className="bg-[#F7F8FC] dark:bg-[#232326] flex h-screen overflow-hidden text-gray-900 dark:text-gray-200 transition-colors duration-300">
                ...
                {/* 3. MAIN CONTENT AREA */}
                <div className={
                    `flex flex-col flex-1 h-full transition-all duration-300 relative w-full ${
                        isLoggedIn ? isSidebarOpen ? "md:ml-64 ml-0" : "md:ml-20 ml-0" : "ml-0"
                    }`
                }>
                    {/* HEADER BAR (Model Selector) */}
                    {
                    isLoggedIn && (
                        <HeaderBar isSidebarOpen={isSidebarOpen}
                            modelList={modelList}
                    ...
                    <div className="relative right-2 z-40">
                        <FloatingButtons messagesContainerRef={messagesContainerRef}
                            isAtBottom={isAtBottom}
                            isAiTypingRef={isAiTypingRef}
                            startAutoScroll={startAutoScroll}
                            autoScrollEnabled={finalAutoScroll}
                    ...
                    {/* INPUT AREA */}
                    <InputArea stopGeneration={stopGeneration}
