#!/usr/bin/env python3
"""
Test script to check the updated chunk_skep functionality with the provided SKEP text
"""
...
print("Now we can see if the BAB sections have content and if Pasal sections have proper parent titles.")
print("The updated function should:")
print("1. Create BAB sections with actual content")
print("2. Have Pasal sections with proper parent_title pointing to their BAB")
print("3. Maintain the hierarchical structure correctly")